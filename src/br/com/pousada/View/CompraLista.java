 ...
 * @author Fabiano
 */
public class CompraLista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("pESquiSAr coMpraS");
        ...
        btMenuPrincipal.setText("Cadastro de Compras");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(painelRolagem, javax.swing.GroupLayout.PREFERRED_SIZE, 443, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void btEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEliminarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            int idCompra = (int) tabela.getValueAt(linhaSelecionada, 0);
            CompraController hc = new CompraController();
            if (hc.remove(idCompra)) {
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            ...
            CompraCadastro h1 = new CompraCadastro(modelo, linhaSelecionada, idCompra);
    ...
    private void txPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txPesquisarActionPerformed
        ...
        modelo.setNumRows(0);
        for (Compra fo : hc.listByNome(nome)) {
            modelo.addRow(new Object[]{
                fo.getIdCompra(),
                fo.getNome(),
                fo.getQuantidadeCompra(),
                fo.getFuncionario(),
                fo.getFornecedor()
            });
        }       
    ...
    private void btMenuPrincipalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btMenuPrincipalActionPerformed
        // TODO add your handling code here:
        CompraCadastro hc = new CompraCadastro();
    ...
    private void preencherJTable() {
        ...
        CompraController uc = new CompraController();
        for (Compra fo : uc.listAll()) {
            modelo.addRow(new Object[]{
                fo.getIdCompra(),
                fo.getNome(),                
                fo.getQuantidadeCompra()
