 ...
 * @author Fabiano
 */
public class LocacaoLista extends javax.swing.JFrame {
   ...
   // private int linhaSelecionada;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("pESquiSAr LOcaCões");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(painelRolagem, javax.swing.GroupLayout.PREFERRED_SIZE, 433, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void btEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEliminarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            int idLocacao = (int) tabela.getValueAt(linhaSelecionada, 0);
            LocacaoController hc = new LocacaoController();
            if (hc.remove(idLocacao)) {
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            ...
            LocacaoCadastro h1 = new LocacaoCadastro(modelo, linhaSelecionada, idLocacao);
    ...
    private void txPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txPesquisarActionPerformed
        ...
        modelo.setNumRows(0);
        for (Locacao fo : hc.listByNome(nome)) {
            modelo.addRow(new Object[]{
                fo.getId(),
                fo.getHabitacao(),
                fo.getCliente(),
                fo.getFuncionario(),
                fo.getQuantidadeLocacao(),
                fo.getDataEntrada(),
                fo.getDataSaida(),
                fo.getValorLocacao(),
                fo.getNumeroPessoas()
    ...
    private void criaJTable() {
        ...
        modelo.addColumn("Valor da Locacao");                
        preencherJTable();
    }

    private void preencherJTable() {

        LocacaoController uc = new LocacaoController();
        for (Locacao fo : uc.listAll()) {
            modelo.addRow(new Object[]{
                fo.getId(),
                fo.getCliente(),                
                fo.getNumeroPessoas(),                
