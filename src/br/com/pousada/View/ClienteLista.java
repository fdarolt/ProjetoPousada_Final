...
import br.com.pousada.View.ClienteCadastro;
...
public class ClienteLista extends javax.swing.JFrame {
   ...
   // private int linhaSelecionada;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("pESquiSAr cLiENteS");
        ...
        btMenuPrincipal.setText("Cadastro Clientes");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(painelRolagem, javax.swing.GroupLayout.DEFAULT_SIZE, 443, Short.MAX_VALUE))
        );
    ...
    private void btEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEliminarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
           ...
           ClienteController fc = new ClienteController();
            Cliente f = fc.listId(idCliente);
            if (fc.remove(idCliente)) {
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (linhaSelecionada >= 0) {
            ...
            ClienteCadastro f1 = new ClienteCadastro(modelo, linhaSelecionada,idCliente);
    ...
    private void txPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txPesquisarActionPerformed
        ...
        modelo.setNumRows(0);
        for (Cliente c : fc.listByNome(nome)) {
            modelo.addRow(new Object[]{
                c.getId(),
                c.getNome(),               
                c.getTelefoneResidencial(),
    ...
    private void btMenuPrincipalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btMenuPrincipalActionPerformed
        // TODO add your handling code here:
        ClienteCadastro fc = new ClienteCadastro();
    ...
    private void preencherJTable() {
        ...
        for (Cliente c : uc.listAll()) {
            modelo.addRow(new Object[]{
                c.getId(),
                c.getNome(),               
                c.getTelefoneEmpresaCliente(),
                c.getTelefoneCelular()});
        }
    }
}