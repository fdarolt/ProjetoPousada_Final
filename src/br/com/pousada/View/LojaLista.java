...
public class LojaLista extends javax.swing.JFrame {
   ...
   // private int linhaSelecionada;
    ...
    private void initComponents() {
        ...
        jLabel5.setText("pESquiSAr VenDAS");
    ...
    private void txPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txPesquisarActionPerformed
       ...
       LojaController hc = new LojaController();
        ...
        modelo.setNumRows(0);
        for (Loja fo : hc.listByNome(nome)) {
            modelo.addRow(new Object[]{
                fo.getId(),
                fo.getFormaPagamento(),
                fo.getCliente(),
                fo.getFuncionario(),
                fo.getVenda()
            });
    ...
    private void btMenuPrincipalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btMenuPrincipalActionPerformed
        // TODO add your handling code here:
        LojaCadastro hc = new LojaCadastro();
    ...
    private void preencherJTable() {
       ...
       LojaController uc = new LojaController();
        for (Loja fo : uc.listAll()) {
            modelo.addRow(new Object[]{
                fo.getId(),
                fo.getVenda(),                
                fo.getFormaPagamento()
